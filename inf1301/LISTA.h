...
/***********************************************************************
*
*  $FC Função: LIS  &Excluir Valor
*
*  $ED Descrição da função
*     Libera o espaco de memoria utilizado pelo pValor
*
*  $EP Parâmetros
*     pDado  - ponteiro para valor do elemento da lista
*
*  $FV Valor retornado
*     void
*
***********************************************************************/
    ...
    void LIS_ExcluirValor (void* pDado);


/***********************************************************************
*
*  $FC Função: LIS  &InsereBloco
*
*  $ED Descrição da função
*     Remove a lista que comeca no elemento corrente do segundo
*     parametro no final da lista referenciada pelo primeiro.
*
*  $EP Parâmetros
*     pLista  - ponteiro para a cabeca de lista onde o bloco
*               sera inserido.
*
*     bloco   - ponteiro para a cabeca de lista da onde o bloco
*               sera retirado.
*
*  $FV Valor retornado
*     Retorna o ponteiro para a lista onde o bloco foi inserido.
*
***********************************************************************/

    LIS_tppLista LIS_InsereBloco (LIS_tppLista pLista, LIS_tppLista bloco);
